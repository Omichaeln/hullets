...
export type QrAuthority = "none" | "digital_fiscal" | "zimra_verified";
export type QrEvidence = { attempted: boolean; status: "not_attempted" | "no_code" | "invalid_url" | "blocked_url" | "fetch_failed" | "unsupported_content" | "parsed"; authority: QrAuthority; authorityHost: string | null; decoder: string; format: string | null; codeSha256: string | null; urlHost: string | null; urlPath: string | null; queryKeys: string[]; finalHost: string | null; finalPath: string | null; contentType: string | null; documentSha256: string | null; fetchedAt: string | null; fields: string[]; warnings: string[]; errorCode: string | null };
