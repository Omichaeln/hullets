...
add("dark-A", "Underexposed photo", { disposition: ["reupload", "review"], notQualified: true, outlet: "MOP-HRE-01" }, async () => photo(await rc(two("A", "004571", "13/10/2026")), { dark: 150, noise: 18, blur: 1.5 }));
